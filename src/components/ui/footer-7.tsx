  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-dark-blue text-white">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="mt-8 flex flex-col justify-between gap-4 border-t border-gray-800 py-8 text-xs font-normal text-white md:flex-row md:items-center md:text-left">
          ...
          <ul className="order-1 flex flex-col gap-4 md:order-2 md:flex-row md:gap-6">
            {legalLinks.map((link, idx) => (
              <li key={idx} className="transition-colors">
                <a href={link.href} className="whitespace-nowrap text-[#EAB308] hover:underline">{link.name}</a>
              </li>
            ))}
          </ul>
        </div>
