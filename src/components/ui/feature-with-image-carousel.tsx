        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 sm:gap-8 lg:gap-12 lg:flex-row-reverse">
          ...
          <div className="flex flex-col gap-6 order-1 lg:order-2">
            ...
            <div className="space-y-4">
              ...
              <a href="/prestations" className="mt-4 inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-darker-blue bg-primary-500 hover:bg-primary-400 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer">
                En savoir plus
